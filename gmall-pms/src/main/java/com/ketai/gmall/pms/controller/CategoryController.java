...
public class CategoryController {
  ...
  /** 分类维护 */
  @ApiOperation("分类查询(排序)")
  @GetMapping()
  @PreAuthorize("hasAuthority('pms:category')")
  public Resp<Object> listCategoryByLevel(ListCategoryByLevel level) {
    List<CategoryEntity> list = categoryService.listCategoryByLevel(level);
    return Resp.ok(list);
  }
}
